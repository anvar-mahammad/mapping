...
class GoToTargetRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GoToTargetRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GoToTargetRequest
    let len;
    let data = new GoToTargetRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToTargetRequest(null);
...
class GoToTargetResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GoToTargetResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GoToTargetResponse
    let len;
    let data = new GoToTargetResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ball_chaser/GoToTargetResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToTargetResponse(null);
...
module.exports = {
  Request: GoToTargetRequest,
  Response: GoToTargetResponse,
  md5sum() { return 'c8652349d2a34a90a09475339e2a93d9'; },
  datatype() { return 'ball_chaser/GoToTarget'; }
};
